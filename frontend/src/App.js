...
import RansomwarePage from "pages/Ransomware2";
			...
			<Router>
				<Routes>
					<Route
						...
						element={user ? <RansomwarePage/> : <ComponentRenderer />}
					/>
					<Route
					...
					<Route
						path="/login"
						element={user ? <RansomwarePage/> : <Login/>}
					/>
					...
					<Route
						path="/signup"
						element={user ? <RansomwarePage/> : <SignUp/>}
					/>
